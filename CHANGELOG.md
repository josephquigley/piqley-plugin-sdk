...
- `plugin-update.sh` sed now scoped to the piqley-plugin-sdk dependency in Package.swift, handling both `exact:` and `.upToNextMajor(from:)` constraints without clobbering other dependencies
